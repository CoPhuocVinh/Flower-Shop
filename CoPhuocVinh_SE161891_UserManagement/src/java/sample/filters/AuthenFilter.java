...
public class AuthenFilter implements Filter {
    ...
    public AuthenFilter() {
        ...
        NON_AUTHEN_RESOURCES.add("loginGmailController");
        ...
        //NON_AUTHEN_RESOURCES.add("History.jsp");
        //NON_AUTHEN_RESOURCES.add("History.jsp");
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        try {
            ...
            log("Loi o filter do"+ e.toString());
        }
